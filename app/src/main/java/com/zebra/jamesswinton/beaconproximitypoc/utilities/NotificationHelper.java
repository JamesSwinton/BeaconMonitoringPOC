...
import com.zebra.jamesswinton.beaconproximitypoc.BeaconMonitoringService;
import com.zebra.jamesswinton.beaconproximitypoc.R;
...
public class NotificationHelper {
    ...
    // Actions
    public static final String ACTION_STOP_SERVICE = "beaconproximitypoc.stop_service";

    public static Notification createNotification(Context cx) {
        // Create Variables
        String channelId = "com.zebra.beacon_monitoring_poc";
